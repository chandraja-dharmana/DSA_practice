...
class Graph:
    def __init__(self, size):
        ...
        #[[None] * size for _ in range(size)] or [[0] * size for _ in range(size)]
        # unweighted ----> [0] * size for 
        # weighted -------> [None] * size for 
        # None → no edge
        # 0    → edge exists with weight 0
        # 5    → edge exists with weight 5
        self.size = size
